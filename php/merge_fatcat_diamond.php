<?PHP
  ...
  //$alt_dir = $argv[10];
   ...
   $handle0 = fopen($file0, 'r');
     ...
     $file1 = $out_dir . $species1 . "_" . $species2 . "_fatcat_diamond_top10.txt";
     $handle1 = fopen($file1, 'w');

     $file2 = $flag_dir . $species1 . "_" . $species2 . "_fatcat_diamond_flagged.txt";
     $handle2 = fopen($file2, 'w');

     $fileM = $matrix_dir . $species1 . "_" . $species2 . "_fatcat_diamond_matrix" . ".txt";
